...
namespace OOP5.source.Database
{
    ...
    public class ProductDatabase
    {
        ...
        {
            SessionManager.Instance.DatabaseInstance.ShopDatabase.CreateTable("ProductGPU",
                @"SerialModel TEXT,
                ProductName TEXT,
                Description TEXT,
                Price REAL,
                Picture TEXT");
            SessionManager.Instance.DatabaseInstance.ShopDatabase.CreateTable("ProductHDD",
                @"SerialModel TEXT,
                ProductName TEXT,
                Description TEXT,
                Price REAL,
                Picture TEXT");
            SessionManager.Instance.DatabaseInstance.ShopDatabase.CreateTable("ProductRAM",
                @"SerialModel TEXT,
                ProductName TEXT,
                Description TEXT,
                Price REAL,
        ...
        {
            SessionManager.Instance.DatabaseInstance.ShopDatabase.CreateTable(name,
                @"SerialModel TEXT,
                ProductName TEXT,
                Description TEXT,
                Price REAL,
        ...
        public void AddProduct(string type, string productSerialModel, string productName, string productDescription, float productPrice, string productImage)
        {
        ...
        public void RemoveProduct(string type, string serialModel)
        {
            ...
            SessionManager.Instance.DatabaseInstance.CommentsDB.RemoveAllCommentItemsWithSerialModel(serialModel);
            SessionManager.Instance.DatabaseInstance.WishlistDB.RemoveAllWishlistItemsWithSerialModel(serialModel);
        ...
        public Product SelectProduct(string type, string serialModel)
        {
            ...
            List<string> item = db.SelectItem(type, "SerialModel, ProductName, Description, Price, Picture", "SerialModel = '" + serialModel + "'");
            Product selected;
            selected = new Product(type, item[0], item[1], item[2], float.Parse(item[3]), new Bitmap(Base64.Base64ToImage(item[4])));
        ...
        public Product SelectProduct(string serialModel)
        {
            ...
            {
                if (db.CountWhere(SessionManager.Instance.DatabaseInstance.ProductTables[i], "SerialModel = '" + serialModel + "'") == 1)
                {
                    List<string> item = db.SelectItem(SessionManager.Instance.DatabaseInstance.ProductTables[i], "SerialModel, ProductName, Description, Price, Picture", "SerialModel = '" + serialModel + "'");
                    selected = new Product(SessionManager.Instance.DatabaseInstance.ProductTables[i],
                    item[0], item[1], item[2], float.Parse(item[3]), new Bitmap(Base64.Base64ToImage(item[4])));
                    return selected;
                }
            }
